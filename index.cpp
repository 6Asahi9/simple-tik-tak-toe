...
int main(){
    ...
    while(running){
        ...
        //after the player moves , lets assign the drawBoard() again to show any changes
        drawBoard(spaces);
...
void playerMove(char *spaces, char player){
    ...
    do{
        ...
        std::cin>>number;
        number--; //cos array starts with zero 
        if(spaces[number]==' '){
